        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for results in listings:
                    ...
                    XPATH_RATING_IMG = ".//div[@class='listing__ratings--roots']//div//a//img//@src"
                    ...
                    raw_rating_img = results.xpath(XPATH_RATING_IMG)
                    ...
                    ratings = [float(x) for x in [rating, rating_img] if x is not None]
                    rating_score = str(sum(ratings) / len(ratings)) if ratings else None
...
if __name__ == "__main__":
    ...
    output_file = f'{helper(keyword)}_{helper(place)}_yellowpages_scraped_data.csv'
    fieldnames = [
        'business_name',
        'business_page', 
        'telephone', 
